...
1. ~~Анонимный~~ тест об ожиданиях от курса Информатики (1 балл + 1.25 за своевременность)
2. 7 аннотаций, сдаваемых в начале каждой лекции (7\*2 баллов + 7\*1.25 за своевременность)
3. 6 лабораторных:
...
5. Экзамен (20 баллов, **автомат** на ~13(сумма баллов за 1-4 пункт*0.185) баллов при 4х первых лабах и 2х ЦДО-тестах на 60%+)
6. Полезные ссылки/смешные мемы (3 балла)

[Журнал 2022-23](https://docs.google.com/spreadsheets/d/1r6v5E_rWELaAjWtlayyBiXJsQNYZvkREbSepKeY3C8U/edit?usp=sharing)

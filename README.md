...
- [I Семестр](#i-семестр)
  ...
  - [Гелиус](#гелиус)
    - [Подключение](#подключение)
      ...
      - [PowerShell (консоль)](#powershell-консоль)
      - [PuttY (консоль)](#putty-консоль)
      - [PowerShell (для загрузки файлов)](#powershell-для-загрузки-файлов)
      ...
      - [Лайфхаки](#лайфхаки)
    - [Cоздание перманентной переменной окружения](#cоздание-перманентной-переменной-окружения)
    - [Траблы](#траблы)
    - [Приколы](#приколы)
